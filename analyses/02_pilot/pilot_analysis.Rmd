...
# create brm to check for hypothesis 1-3 (right-handed participants)
model_right <- brm(
...
model_both <- brm(
  formula = logRT ~ Mapping * Response * handedness +
           (Response || Participant),
  data = data,
  family = "student"
)
...
pp_check(model_right_student)

gaussian_loo <- loo(model_right)
student_loo <- loo(model_right_student)

loo_comp <- loo_compare(list(gaussian = gaussian_loo, student = student_loo))
...
h1 <- hypothesis(model_right, "Intercept + Responseright < Intercept + Mappingincompatible + Responseright + Mappingincompatible:Responseright")
print(h1, digits = 4)

# H2: Left-hand responses are faster to the smaller stimulus than to the larger stimulus.
h2 <- hypothesis(model_right, "Intercept < Intercept + Mappingincompatible")
print(h2, digits = 4)
...
h3 <- hypothesis(model_right, "Intercept + Mappingincompatible + Responseright + Mappingincompatible:Responseright - (Intercept + Responseright) > Intercept + Mappingincompatible - (Intercept)")
print(h3, digits = 4)
