...
According to these rules we can conclude the following for our hypotheses: <br>
...
Figure 4 (left-handed data) and 5 (right-handed data) use Local Polynomial Regression Fitting (loess) to fit curves to the reaction time data. Here, we distingues between the S-R-Mappings and whether participants responded with their left or right hand.
