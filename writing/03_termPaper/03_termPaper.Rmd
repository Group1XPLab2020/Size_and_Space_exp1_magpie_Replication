...
When setting a random seed of 42 our analysis script yields the following results for our hypotheses (Table 1).
...
Hypothesis 3 receives enough support to be accepted. However since we did not find the assumed effect for left-hand responses (H2), the result of H3 is not very useful either.<br>
