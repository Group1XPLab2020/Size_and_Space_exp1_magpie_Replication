...
<center> <h5>University of Osnabrück</h5> </center>
<br>
<br>
...
h_testing <- tibble(Hypothesis = c(1,2,3,4,5,6,7),
       Bayes_factor = c(h1$hypothesis$Evid.Ratio,h2$hypothesis$Evid.Ratio,h3$hypothesis$Evid.Ratio,h4$hypothesis$Evid.Ratio,h5$hypothesis$Evid.Ratio,h6$hypothesis$Evid.Ratio,h7$hypothesis$Evid.Ratio),
       Post_prob = c(h1$hypothesis$Post.Prob,h2$hypothesis$Post.Prob,h3$hypothesis$Post.Prob,h4$hypothesis$Post.Prob,h5$hypothesis$Post.Prob,h6$hypothesis$Post.Prob,h7$hypothesis$Post.Prob)
       )

apa_table(h_testing, caption = "Results of hypothesis testing"
, note = "For each hypothesis the respective Bayes factor and posterior probability is displayed."
)
